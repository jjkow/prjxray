...
export XRAY_PINCFG=${XRAY_PINCFG:-ZYBOZ7-SWBUT}
...
cat >/dev/null <<EOF
pushd ${XRAY_DIR}
source minitests/roi_harness/zybo.sh
...
echo "Design: small"
export DIN_N=${XRAY_DIN_N_SMALL:-4}
export DOUT_N=${XRAY_DOUT_N_SMALL:-4}
export XRAY_ROI=${XRAY_ROI_SMALL:-SLICE_X22Y50:SLICE_X29Y64}
